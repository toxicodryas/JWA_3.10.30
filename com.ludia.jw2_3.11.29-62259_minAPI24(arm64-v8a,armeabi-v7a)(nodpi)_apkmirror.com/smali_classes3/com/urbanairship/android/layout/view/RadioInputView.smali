...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "model",
        "(Landroid/content/Context;Lcom/urbanairship/android/layout/model/RadioInputModel;)V",
        "createCheckboxView",
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/urbanairship/android/layout/model/RadioInputModel;)V
    .locals 1
    ...
    .line 20
    new-instance p1, Lcom/urbanairship/android/layout/view/RadioInputView$1;

    invoke-direct {p1, p0}, Lcom/urbanairship/android/layout/view/RadioInputView$1;-><init>(Lcom/urbanairship/android/layout/view/RadioInputView;)V

    check-cast p1, Lcom/urbanairship/android/layout/model/BaseModel$Listener;

    invoke-virtual {p2, p1}, Lcom/urbanairship/android/layout/model/RadioInputModel;->setListener$urbanairship_layout_release(Lcom/urbanairship/android/layout/model/BaseModel$Listener;)V

    return-void
.end method

.method public static final synthetic access$setCheckedInternal(Lcom/urbanairship/android/layout/view/RadioInputView;Z)V
    .locals 0

    .line 14
    invoke-virtual {p0, p1}, Lcom/urbanairship/android/layout/view/RadioInputView;->setCheckedInternal(Z)V
...
.method protected createCheckboxView(Lcom/urbanairship/android/layout/property/CheckboxStyle;)Lcom/urbanairship/android/layout/widget/ShapeButton;
    ...
    .line 44
    invoke-virtual {p0}, Lcom/urbanairship/android/layout/view/RadioInputView;->getContext()Landroid/content/Context;
    ...
    .line 43
    new-instance p1, Lcom/urbanairship/android/layout/view/RadioInputView$createCheckboxView$1;

    move-object v2, p1

    move-object v3, p0

    invoke-direct/range {v2 .. v8}, Lcom/urbanairship/android/layout/view/RadioInputView$createCheckboxView$1;-><init>(Lcom/urbanairship/android/layout/view/RadioInputView;Landroid/content/Context;Ljava/util/List;Ljava/util/List;Lcom/urbanairship/android/layout/property/Image$Icon;Lcom/urbanairship/android/layout/property/Image$Icon;)V
